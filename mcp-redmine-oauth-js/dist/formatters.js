...
export function formatCreatedIssue(data) {
...
export function formatCreatedProject(data) {
...
export function formatWikiPage(data) {
...
export function formatIssueList(data) {
    ...
    for (const issue of issues) {
        ...
        if (priority.name)
            parts.push(`Priority: ${priority.name}`);
...
export function formatRelations(issueId, data) {
...
export function formatVersions(projectId, data) {
...
export function formatTimeEntries(data) {
    ...
    for (const entry of entries) {
        ...
        if (activity.name)
            parts.push(`Activity: ${activity.name}`);
        if (parts.length > 0)
            lines.push(`  ${parts.join(" | ")}`);
...
export function formatStatuses(data) {
...
export function formatTrackers(data) {
